...
alias e='exit'
alias enla='source /home/jpell/Scripts/Language/enla.sh'
alias ensv='source /home/jpell/Scripts/Language/ensv.sh'
alias fox='python3 ~/Github/linux-swashbuckling/fox.py'
alias gh='cd ~/Github'
alias gitpull='/home/jpell/Scripts/gitpull.sh'
alias ip='ifconfig'
alias laen='source /home/jpell/Scripts/Language/laen.sh'
alias linux='cd ~/Github/linux-swashbuckling'
alias l='ls'
alias mejor='cd ~/Scripts/MejorCopy'
alias music='cd ~/Music'
alias publicip='curl ifconfig.me'
alias rune='java -jar RuneLite.jar'
